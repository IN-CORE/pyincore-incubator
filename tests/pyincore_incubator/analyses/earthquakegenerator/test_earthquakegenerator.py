...
def run_with_base_class():
    ...
    # Note - this currently only works with this model
    ...
    eq_generator.load_remote_input_dataset("inventory", bldg_dataset_id)
    ...
    eq_generator.set_parameter("ground_motion_type", "PGA")
