...
# full list see the documentation.rst:
...
# documentation.rst root, use os.path.abspath to make it absolute, like shown here.
#
import os
import sys
...
sys.path.insert(0, os.path.abspath("../.."))
sys.path.insert(0, os.path.abspath("../../pyincore_incubator"))
sys.path.insert(0, os.path.abspath("../../pyincore_incubator/analyses"))
sys.path.insert(0, os.path.abspath("../../tests"))
sys.path.insert(0, os.path.abspath("../../docs"))

# -- Project information -----------------------------------------------------

project = "pyIncore-incubator"
author = ""
...
htmlhelp_basename = "pyincoreincubatordoc"
...
latex_documents = [
    (
        master_doc,
        "pyincore-incubator.tex",
        "pyincore-incubator Documentation",
        "ISDA NCSA",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "pyincore-incubator", "pyincore-incubator Documentation", [author], 1)
]
