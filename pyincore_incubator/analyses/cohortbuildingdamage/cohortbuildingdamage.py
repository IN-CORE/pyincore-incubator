...
class CohortBuildingDamage(BaseAnalysis):
    ...
    def __init__(self, incore_client):
        super(CohortBuildingDamage, self).__init__(incore_client)
    ...
    def building_damage_analysis(self, building):
        ...
        try:
            ...
            mean_damage["meandamage"] = random.uniform(0.0, max_value)
    ...
    def get_spec(self):
        ...
        return {
            ...
            "input_parameters": [
                ...
                {"id": "max_value",
                 "required": True,
                 "description": "Maximum value for uniform random",
                 "type": float,
                 },
